    ...
    <tbody>
      {% for index, result in results %}
        <tr>
          ...
          <td data-order="{{ result.total_exp }}">{{ result.total_exp|number_format }}</td>
          <td data-order="{{ result.all_time_ts }}">{{ result.all_time_ts|number_format }}</td>
          <td data-order="{{ result.all_time_tpk }}">{{ result.all_time_tpk|number_format }}</td>
